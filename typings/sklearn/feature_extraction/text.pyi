...
class CountVectorizer(_VectorizerMixin, BaseEstimator):
    ...
    def fit(self, raw_documents: Iterable, y=None) -> Self: ...
    def fit_transform(
        self,
...
class TfidfTransformer(
    ...
    def fit(self, X: MatrixLike, y: None | ndarray | list[Int] = None) -> Self: ...
